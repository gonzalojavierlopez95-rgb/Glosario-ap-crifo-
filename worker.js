...
export default {
  ...
  // FASE 9 — Cron Trigger (ver wrangler.jsonc: corre el día 1 de cada mes
  // a las 00:00 UTC). Calcula el ranking del mes que se acaba de cerrar.
  async scheduled(event, env, ctx) {
    ...
    ctx.waitUntil(calcularYGuardarRanking(env, mesStr));
  }
};
