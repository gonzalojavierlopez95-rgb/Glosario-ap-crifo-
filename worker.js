...
async function generarExplicacionBaneo(env, motivoAdmin, lang) {
  ...
  const promptSistema =
    ...
    `directamente a la persona con un participio o adjetivo que marque género (evitá construcciones como ` +
    `"has sido apartado", "quedaste suspendido", "fuiste sancionado" — esas formas son masculinas y ` +
    `excluyen a una lectora). En su lugar, hacé que el sujeto gramatical de la sanción sea algo neutro: ` +
    `"tu acceso a la Comunidad Apócrifa fue restringido", "tu participación quedó suspendida", "este ` +
    `vínculo fue interrumpido", etc. Usá "vos"/"tu"/"tus" con total libertad, pero revisá que ningún ` +
    `adjetivo o participio de la oración concuerde en género con la persona misma. ` +
